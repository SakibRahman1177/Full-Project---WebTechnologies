<?php  
require_once 'controller/reciptionistinfo.php';
...
$(document).ready(function(){
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("model/reciptionistsearch.php", {term: inputVal}).done(function(data){
...
<?php include 'controller/Head1.php';?>
    <!--<form method="post" action="controller/findreciptionist.php">
      <h1>SEARCH FOR RECIPTIONIST</h1>
    ...
    <form>
      <div class="search-box">
        <input type="text" autocomplete="off" placeholder="Search Reciptionist..." />
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      ...
      <h1>All Reciptionist Information</h1><hr>
<table>
	<thead>
		<tr>
		<th>Name</th>
	...
	<tbody>
		<?php foreach ($users as $i => $user): ?>
			<tr>
				<td><a href="showreciptionist.php?id=<?php echo $user['ID'] ?>">
