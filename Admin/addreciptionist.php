...
<?php include 'controller/Head1.php';?>
    ...
    <hr>
    <form method="post" action="<?php echo htmlspecialchars('controller/reciptionistcontroller.php');?>">
      
      <h1><span style="font-weight: bold;font-size: 25px;">RECIPTIONIST</span></h1>  <hr>
