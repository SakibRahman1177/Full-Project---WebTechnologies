...
$flag=1;
$name = $email = $Pnumber = $address = $Patientreport = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["gender"])) {
    ...
    $gender = test_input($_POST["gender"]);
     ...
     if (empty($_POST["Patient Report"])) {
    echo "Patient Report is required";
    $flag=0;
  } else {
    $Patientreport = test_input($_POST["Patient Report"]);
  }
  }
  } 
 if ($flag==1) {
  ...
  $data['gender']=$gender;
  $data['Patient Report']=$Patientreport;
